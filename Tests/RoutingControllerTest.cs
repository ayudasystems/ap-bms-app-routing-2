...
namespace Ayuda.AppRouter.Tests
{
    ...
    {
        // --- Mocks and Setup from your code ---
        ...
        // --- HELPER: SetupMockBackendResponse  ---
        ...
        public async Task Route_When_Highest_Priority_Path_Differs_From_Tenant_Sends_Correct_Header()
        {
            ...
            httpContext.Request.ContentType = "text/xml"; // Example content type

            // Override default PathFinder setup to return a valid path
            ...
            // 3. Verify method and body were proxied
            ...
            // 4. Verify X-Ayuda-Resolved-Path header was added correctly
            ...
            // 5. Verify dependencies were called
             _mockVersionProvider.Verify(vp => vp.GetVersion(tenantHost), Times.Once);
             ...
             // 6. Verify response from backend was proxied (optional check)
             httpContext.Response.Body.Position = 0;
             using var reader = new StreamReader(httpContext.Response.Body);
             string responseBody = await reader.ReadToEndAsync();
             Assert.Equal("Backend Response OK", responseBody);
